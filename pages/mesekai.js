  ...
  return (
    <div id="mesekai">
      <Row>
        <Col span={4}>
          <Tabs defaultActiveKey="1">
            <TabPane tab="Avatars" key="1" type="card">
              <Button
                style={{
                  background: `url('thumbnails/avatar/xbot.png')`,
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/ybot.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/liam.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/malcolm.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/regina.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/remy.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/shae.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/avatar/stefani.png')`,
                  backgroundPosition: "center",
                }}
            ...
            <TabPane tab="Worlds" key="2" type="card">
              <Button
                style={{
                  background: `url('thumbnails/world/grid.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/world/house.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/world/forest.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/world/castle.png')`,
                  backgroundPosition: "center",
                }}
              ...
              <Button
                style={{
                  background: `url('thumbnails/world/space.png')`,
                  backgroundPosition: "center",
                }}
        ...
        <Col span={20}>
          <div ref={canvas}></div>
          <canvas ref={canvasInput} className={styles.guides}></canvas>
          <video
      ...
      <h1 ref={preload}>
        <span className={styles.loadingtext}>
          {" "}
          Loading Avatar Tracking <Spin indicator={antIcon} />
        </span>
      </h1>
    </div>
  );
